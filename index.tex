...
\protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b4101d79d.pdf}
Time
...
12:00 - 14:00 & Lunch \\
14:00 - 14:50 &
\protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b5c1d85dd.pdf}
\textbf{G. Magaril-Il'yaev} (Lecture 1) \\
14:50 - 15:10 & Coffee break \\
15:10 - 16:00 &
\protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b5d827ae7.pdf}
...
\toprule
\begin{minipage}[b]{\linewidth}\raggedright
\protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b59214390.pdf}
Time
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
Activity
\end{minipage} \\
...
\toprule
\begin{minipage}[b]{\linewidth}\raggedright
\protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b33a3b2b9.pdf}
Time
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
Activity
\end{minipage} \\
...
\toprule
\begin{minipage}[b]{\linewidth}\raggedright
\protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b74d43d31.pdf}
Time
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
Activity
\end{minipage} \\
...
\endhead
9:00 - 9:50 &
\protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b72700648.pdf}
\textbf{B. Mordukhovich} (Lecture 1) \\
9:50 - 10:10 & Coffee break \\
10:10 - 11:00 &
\protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b7044ce67.pdf}
\textbf{B. Mordukhovich} (Lecture 2) \\
11:00 - 14:00 & Lunch \\
14:00 - 14:50 &
\protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b64a9a976.pdf}
\textbf{L. Lokutsievskiy} (Lecture 1) \\
14:50 - 15:10 & Coffee break \\
15:10 - 16:00 &
\protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b1ea5d3c2.pdf}
...
\toprule
\begin{minipage}[b]{\linewidth}\raggedright
\protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b772bff8.pdf}
Time
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
Activity
\end{minipage} \\
...
\endhead
9:00 - 9:50 &
\protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b5bf2c0ba.pdf}
\textbf{B. Mordukhovich} (Lecture 3) \\
9:50 - 10:10 & Coffee break \\
10:10 - 12:10 & \protect\hyperlink{se}{Session 2} \\
12:10 - 14:00 & Lunch \\
14:00 - 14:50 &
\protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b5942e57e.pdf}
...
\item
  ...
  output feedback.
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b6350b83e.pdf}
...
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b5f222256.pdf}
...
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b3eeb503d.pdf}
...
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b4dfc2ff5.pdf}
...
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b5c983d96.pdf}Nina
...
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b4c8fcec4.pdf}
...
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b50432094.pdf}
  Ilya Chupin, Yurii Dolgii (Ural Federal university, Ekaterinburg,
  Russia). Optimal Control of Manipulator.
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b3f857672.pdf}
...
\item
  ...
  KPZ-nonlinearities.
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b4550f5d8.pdf}
...
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b14e03c12.pdf}
...
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b5c0c4237.pdf}
...
\tightlist
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b2f2c740a.pdf}
...
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b6bbfc82.pdf}
...
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b3dd8f5c2.pdf}
  ...
  Multioperators.
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b23cc11a.pdf}
  Ekaterina I. Zotova, R.D. Murtazina (USATU, Ufa, Russia). Laplace
  Cascade method.
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b76867658.pdf}
  ...
  nonlinear lattices.
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b55c080cc.pdf}
...
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b32515a3f.pdf}
...
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b37884df5.pdf}
...
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b31de06aa.pdf}
...
\tightlist
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871bfd3d526.pdf}
...
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b10a99186.pdf}
...
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b6581b963.pdf}
...
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b4a81258.pdf}
  ...
  Annular Channel.
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b31997ce.pdf}
...
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b55c687cb.pdf}
...
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b6951bbce.pdf}
...
\tightlist
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b21bf6b91.pdf}
...
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b5d3947c3.pdf}
...
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b45447c88.pdf}
...
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b7b02510f.pdf}
  ...
  and codifferentials.
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b408a0002.pdf}
...
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b24669edf.pdf}
  ...
  variables.
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871b39eda14c.pdf}
...
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871be862ff7.pdf}
  ...
  Systems.
\item
  \protect\includegraphics[height=0.7em]{/tmp/RtmpLIDCxv/file871bfedc75.pdf}
